...
//var { medicalHistory } = require('./blockchainController/queries')
//
...
async function queryMeds(data, fcn){
	console.log("medical data",data,fcn, data.key);
...
return Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	// queryMed chaincode function - requires 1 argument, ex: args: ['MED1'],
	// queryAllMeds chaincode function - requires no arguments , ex: args: [''],
	const request = {
