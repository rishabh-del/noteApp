...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang"  ]; then
	...
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/medical/java
elif [ "$CC_SRC_LANGUAGE" = "javascript" ]; then
	CC_RUNTIME_LANGUAGE=node # chaincode runtime language is node.js
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/medical/javascript
elif [ "$CC_SRC_LANGUAGE" = "typescript" ]; then
	CC_RUNTIME_LANGUAGE=node # chaincode runtime language is node.js
	CC_SRC_PATH=/opt/gopath/src/github.com/chaincode/medical/typescript
	echo Compiling TypeScript code into JavaScript ...
	pushd ../chaincode/medical/typescript
	npm install
	npm run build
	popd
...
Next, use the medical applications to interact with the deployed medical contract.
The medical applications are available in multiple programming languages.
